...
const Services = () => {
  return (
    <section className="lg:-mt-[150px] py-[50px] text-black font-medium font-primary flex flex-col items-center justify-center">
      ...
      <div className=" w-full flex flex-col lg:flex-row flex-wrap justify-center gap-10 lg:gap-6">
